...
# EXPERIMENT_NAME = "adult-income-franxisco"
...
def main():
    ...
    train_df, test_df = load_data(
        DATA_DIR / "adult.data", DATA_DIR / "adult.test")
    ...
    with mlflow.start_run(run_name=run_name) as run:
        ...
        logger.info(
            f"Model training complete. Time taken: {elapsed:.2f} seconds")
        ...
        mlflow.log_artifact(str(MODEL_DIR / "encoders.pkl"),
                            artifact_path="preprocessing")
